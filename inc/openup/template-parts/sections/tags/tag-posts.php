<?php
$cur_tag = get_queried_object()->slug;
...
<?php if ($posts_query): ?>
    <section class="s-blog-posts u-bg-secondary-skin">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="o-banner__title u-color-primary-dark-blue text-center"><?php _e('De laatste updates', 'openup'); ?></h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 p-0">
                    <div class="s-blog-post__filter JS-post-filter-slider JS-filter-slider">
                        <?php get_template_part('template-parts/components/filters/tags-page-filters'); ?>
                    </div>
                </div>
            </div>
            <div class="js-filter">
