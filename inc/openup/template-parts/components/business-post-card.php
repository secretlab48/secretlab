...
$category = wp_get_post_terms($post->ID, 'business_posts_types_tax', array('fields' => 'names'));
$thema_tax = wp_get_post_terms($post->ID, 'business_posts_themas_tax', array('fields' => 'names'));
